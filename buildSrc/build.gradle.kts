...
dependencies {
  ...
  runtimeOnly("org.codehaus.plexus:plexus-xml:3.0.2") // Do not bump to plexus-xml 4.x which requires Java17
  ...
  runtimeOnly("com.diffplug.spotless:spotless-plugin-gradle:8.10.1")                                        // Enable a code formatting plugin
